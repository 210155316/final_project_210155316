...
Please visit my GITHUB to access all documentation related to this project! 
...
More detailed explanations of the variables used and data origins can be accessed in the CODEBOOK.
...
Due to the large amount of data wrangling needed for this data set, 16 functions were created. Details on these can be found in the [codebook](https://github.com/210155316/210155316_project/blob/main/data/codebook.txt). 
